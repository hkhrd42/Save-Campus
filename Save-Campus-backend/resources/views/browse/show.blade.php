                ...
                <div class="p-8">
                    ...
                    @if($meal->image_path)
                        <div class="mb-6 overflow-hidden rounded-lg">
                            <img src="{{ asset('storage/' . $meal->image_path) }}" alt="{{ $meal->name }}" class="w-full h-auto max-h-96 object-cover">
                        </div>
                    @else
                        <div class="mb-6 w-full h-64 bg-gray-200 rounded-lg flex items-center justify-center">
