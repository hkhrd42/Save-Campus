                            ...
                            <div class="p-6">
                                ...
                                @if($meal->image_path)
                                    <div class="mb-4 overflow-hidden rounded-lg">
                                        <img src="{{ asset('storage/' . $meal->image_path) }}" alt="{{ $meal->name }}" class="w-full h-40 object-cover group-hover:scale-110 transition-transform duration-300">
                                    </div>
                                @else
                                    <div class="mb-4 overflow-hidden rounded-lg bg-gray-200 flex items-center justify-center h-40">
